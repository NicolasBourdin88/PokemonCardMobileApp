...
import com.example.pokemonultimate.data.model.userModel.database.PokemonCellProfilConverter

@Database(entities = [PokemonCardEntity::class, RemoteKey::class, UserProfile::class], version = 1)

@TypeConverters(PokemonCardEntity.Converters::class,PokemonCellProfilConverter::class)
